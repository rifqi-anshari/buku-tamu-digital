            ...
            <div class="col-md">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <h6 class="m-0 font-weight-bold text-primary">Buku Tamu > Total Tamu

                                </h6>
                            </div>
                            <div class="col-8">
                                <form method="post" action="halaman_tamu_total.php">
                                    <div class="input-group col-4 pull-right row">
                                        ...
                                        <a type="button" href="halaman_tamu_total.php" class="btn btn-warning">Reset</a>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-7 pull-left" style="width: 800px;height: 380px">
